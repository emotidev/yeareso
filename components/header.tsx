...
export default function Navbar({ user, loading = false }: { user: UserProfile; loading?: boolean }) {
  return (
        ...
        <>
          <div className="mx-auto max-w-7xl h-16">
            <div className="relative flex h-16 items-center justify-between">
              {user && (<div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
              ...
              </div>) : (<Link href="/api/auth/login" className="text-lg text-white bg-indigo-600 h-max px-2 py-1 rounded-sm"> Log In </Link>)}
            </div>
          </div>
